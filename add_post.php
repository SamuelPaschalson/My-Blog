...
if(isset($_POST['title'],$_POST['contents'],$_POST['category'])){
    ...
    if(!category_exists($mysqli,'id',$_POST['category'])){
    $errors[] = 'That category does not exists';   
    }
    
    if(empty($errors)){
        add_post($mysqli,$title,$contents,$_POST['category']);
...
<body>
   	...
   	<div class="row">
   		...
   		<div class="header-content twelve columns">
		      ...
		      <h1 id="logo-text"><a href="index.php" title="">Blog</a></h1>
				<p id="intro">A basic idea format of a blog</p>
   ...
   <div id="content-wrap">
     ...
     <div>
       ...
       <select name='category'>
        <?php
        foreach(get_categories($mysqli) as $category){
         ?>
   ...
   <footer>
      ...
      <div class="row"> 
         ...
         <p class="copyright">&copy; Copyright 2023. My Blog. &nbsp; Brought To You by <a title="SamuelPaschalson" href="https://samuel-paschalson.netlify.app/">Chinomso Iyasara<b style="color:red;"> aka</b> Samuel Paschalson</a>.</p>
